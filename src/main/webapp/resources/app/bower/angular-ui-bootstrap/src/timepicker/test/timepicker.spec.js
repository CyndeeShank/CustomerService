describe('timepicker directive', function() {
  ...
  beforeEach(inject(function(_$compile_, _$rootScope_, _$templateCache_) {
    ...
    element = $compile('<uib-timepicker ng-dto="time"></uib-timepicker>')($rootScope);
    $rootScope.$digest();
  ...
  it('has `selected` current time when dto is initially cleared', function() {
    $rootScope.time = null;
    element = $compile('<uib-timepicker ng-dto="time"></uib-timepicker>')($rootScope);
    $rootScope.$digest();
  ...
  it('changes inputs when dto changes value', function() {
  ...
  it('changes only the time part when minutes change', function() {
    element = $compile('<uib-timepicker ng-dto="time" minute-step="15"></uib-timepicker>')($rootScope);
  ...
  describe('attributes', function() {
    beforeEach(function() {
      ...
      element = $compile('<uib-timepicker ng-dto="time" hour-step="hstep" minute-step="mstep" second-step="sstep"></uib-timepicker>')($rootScope);
      $rootScope.$digest();
    });
  ...
  describe('without seconds mode',function(){
    beforeEach(function(){
      ...
      element = $compile('<uib-timepicker ng-dto="time" show-seconds="displaysSeconds"></uib-timepicker>')($rootScope);
      $rootScope.$digest();
    });
  ...
  describe('12 / 24 hour mode', function() {
    beforeEach(function() {
      ...
      element = $compile('<uib-timepicker ng-dto="time" show-meridian="meridian"></uib-timepicker>')($rootScope);
      $rootScope.$digest();
    });
    ...
    it('handles correctly initially empty dto on parent element', function() {
      $rootScope.time = null;
      element = $compile('<span ng-dto="time"><uib-timepicker show-meridian="meridian"></uib-timepicker></span>')($rootScope);
      $rootScope.$digest();
  ...
  describe('`meridians` attribute', function() {
    beforeEach(inject(function() {
      ...
      element = $compile('<uib-timepicker ng-dto="time" meridians="meridiansArray"></uib-timepicker>')($rootScope);
      $rootScope.$digest();
    }));
  ...
  describe('`readonly-input` attribute', function() {
    beforeEach(inject(function() {
      $rootScope.meridiansArray = ['am', 'pm'];
      element = $compile('<uib-timepicker ng-dto="time" readonly-input="true"></uib-timepicker>')($rootScope);
      $rootScope.$digest();
    }));
  ...
  describe('`pad-hours` attribute', function() {
    ...
    it('should not pad the hours', function() {
      element = $compile('<uib-timepicker ng-dto="time" pad-hours="false"></uib-timepicker>')($rootScope);
      $rootScope.$digest();
  ...
  describe('user input validation', function() {
    ...
    it('clears dto when input hours is invalid & alerts the UI', function() {
      var el = getHoursInputEl();
    ...
    it('clears dto when input minutes is invalid & alerts the UI', function() {
      var el = getMinutesInputEl();
    ...
    it('clears dto when input seconds is invalid & alerts the UI', function() {
      var el = getSecondsInputEl();
    ...
    it('should not be invalid when the dto is cleared', function() {
    ...
    it('should have the correct tabindex', function() {
      element = $compile('<uib-timepicker ng-dto="time" tabindex="5"></uib-timepicker>')($rootScope);
      $rootScope.$digest();
  ...
  describe('when dto is not a Date', function() {
    beforeEach(inject(function() {
      element = $compile('<uib-timepicker ng-dto="time"></uib-timepicker>')($rootScope);
    }));

    it('should not be invalid when the dto is null', function() {
      $rootScope.time = null;
      $rootScope.$digest();
      expect(element.hasClass('ng-invalid-time')).toBe(false);
    });

    it('should not be invalid when the dto is undefined', function() {
      $rootScope.time = undefined;
      $rootScope.$digest();
      expect(element.hasClass('ng-invalid-time')).toBe(false);
    });

    it('should not be invalid when the dto is a valid string date representation', function() {
    ...
    it('should be invalid when the dto is not a valid string date representation', function() {
      $rootScope.time = 'pizza';
      $rootScope.$digest();
      expect(element.hasClass('ng-invalid-time')).toBe(true);
    });

    it('should return valid when the dto becomes valid', function() {
      $rootScope.time = 'pizza';
      $rootScope.$digest();
      expect(element.hasClass('ng-invalid-time')).toBe(true);
    ...
    it('should return valid when the dto is cleared', function() {
      $rootScope.time = 'pizza';
      $rootScope.$digest();
      expect(element.hasClass('ng-invalid-time')).toBe(true);
  ...
  describe('use with `ng-required` directive', function() {
    beforeEach(inject(function() {
      $rootScope.time = null;
      element = $compile('<uib-timepicker ng-dto="time" ng-required="true"></uib-timepicker>')($rootScope);
      $rootScope.$digest();
    }));
    ...
    it('should be valid if dto has been specified', function() {
      $rootScope.time = new Date();
      $rootScope.$digest();
  ...
  describe('use with `ng-change` directive', function() {
    beforeEach(inject(function() {
      ...
      $rootScope.time = new Date();
      element = $compile('<uib-timepicker ng-dto="time" ng-change="changeHandler()"></uib-timepicker>')($rootScope);
      $rootScope.$digest();
    }));
    ...
    it('should not be called when dto changes programatically', function() {
      $rootScope.time = new Date();
      $rootScope.$digest();
      expect($rootScope.changeHandler).not.toHaveBeenCalled();
    });
  ...
  describe('when used with min', function() {
    var changeInputValueTo;
    beforeEach(inject(function($sniffer) {
      element = $compile('<uib-timepicker ng-dto="time" min="min"></uib-timepicker>')($rootScope);
      $rootScope.$digest();
      changeInputValueTo = function(inputEl, value) {
        inputEl.val(value);
        inputEl.trigger($sniffer.hasEvent('input') ? 'input' : 'change');
  ...
  describe('when used with max', function() {
    var changeInputValueTo;
    beforeEach(inject(function($sniffer) {
      element = $compile('<uib-timepicker ng-dto="time" max="max"></uib-timepicker>')($rootScope);
      $rootScope.$digest();
      changeInputValueTo = function(inputEl, value) {
        inputEl.val(value);
        inputEl.trigger($sniffer.hasEvent('input') ? 'input' : 'change');
  ...
  describe('custom template and controllerAs', function() {
    it('should allow custom templates', function() {
      ...
      element = $compile('<uib-timepicker ng-dto="time" template-url="foo/bar.html"></uib-timepicker>')($rootScope);
      $rootScope.$digest();
      expect(element[0].tagName.toLowerCase()).toBe('div');
      expect(element.html()).toBe('baz');
    });
  ...
  describe('ngDisabled', function() {
    it('prevents modifying date via controls when true', function() {
      ...
      element = $compile('<uib-timepicker ng-dto="time" ng-disabled="disabled"></uib-timepicker')($rootScope);
      $rootScope.$digest();
  ...
  describe('gc', function() {
    ...
    beforeEach(inject(function() {
      $scope = $rootScope.$new();
      element = $compile('<uib-timepicker ng-dto="time"></uib-timepicker>')($scope);
      $rootScope.$digest();
    }));
